...
#==============================================================================
        if self.state == S_LOGGEDIN:
            ...
            if len(my_msg) > 0:
                ...
                #     game = json.loads(myrecv(self.s))["results"]
                #     if game == "success":
...
#==============================================================================
            ...
            if len(my_msg) > 0:     # my stuff going out
                ...
                if my_msg == "request_to_start_a_game":
                ...
                elif my_msg[:13] == "press_button_":
                    for i in range(1,401):
                        if str(i) == my_msg[13:]:
                            mysend(self.s, json.dumps({"action": "gaming", "from": "[" + self.me + "]", 'operation': i}))
                        else:
                            continue
                    ...
                    my_msg = encrypt(my_msg, codebook, shift)
            ...
            if len(peer_msg) > 0:    # peer's stuff, coming in
                ...
                if peer_msg["action"] == "connect":
                    ...
                    if peer_msg['status'] == 'continue':
                        ...
                        for i in range(1,401):
                            if peer_msg['operation'] == i:
                                self.out_msg += f"systeminfo{i}" + peer_msg['mark'] 
                    ...
                    peer_msg["message"] = decrypt(peer_msg["message"], codebook, shift)
